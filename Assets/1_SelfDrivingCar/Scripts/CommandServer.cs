...
public class CommandServer : MonoBehaviour
{
	...
	{
		//Debug.Log("CommandServer: OnSteer");
	...
	{
		print("CommandServer: EmitTelemetry - Sending");
		UnityMainThreadDispatcher.Instance().Enqueue(() =>
		{
			...
			{
				//print("CommandServer: EmitTelemetry - Really Sending");
		...
		//Debug.Log("CommandServer: EmitTelemetry - Something sent");
